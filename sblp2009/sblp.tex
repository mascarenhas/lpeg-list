...
already proved the equivalecence between \texttt{match} and
$\texttt{match}_L$ when the subject is a string of characters,
we just need to prove the extra cases corresponding to rules $list.1$
