...
The main inspiration of our work in extending PEGs with list patterns was OMeta~\cite{warth:ometa},
an object-oriented language with pattern matching facilities based on PEGs. OMeta operates on
streams of arbitrary host-language objects, and not just lists or characters. In~\cite{warth:thesis},
the main author of OMeta also presents a different operational semantics for list matching. While
the extensions of OMeta do not enforce the compatibility with original PEGs, our approach is more
concerned about this, having proved the equivalence between the \texttt{match} and the $\texttt{match}_L$
relations.
