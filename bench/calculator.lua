...
local function f1()
  for i = 1, #exps_vals do
    assert(math.floor(p:match{ exps_vals[i].exp }) == exps_vals[i].val)
  end
end

local function f2()
   for i = 1, #exps_vals do
     assert(p2:match{ exps_vals[i].exp })
   end
end

local function f3()
  for i = 1, #exps_vals do
    assert(math.floor(p3( exps_vals[i].exp )) == exps_vals[i].val)
  end
end

local function f4()
  for i = 1, #exps_vals do
    assert(p4( exps_vals[i].exp ))
  end
end
